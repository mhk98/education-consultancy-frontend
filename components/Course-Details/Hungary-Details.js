...
import HungaryMenu from "./Course-Sections/Hungary-Menu";
import HungarySidebar from "./Course-Sections/Hungary-Sidebar";
import HungaryOverview from "./Course-Sections/Hungary-Overview";
import HungaryContent from "./Course-Sections/Hungary-Content";
import HungaryRequirements from "./Course-Sections/Hungary-Requirements";
import HungaryVisa from "./Course-Sections/Hungary-Visa";
import HungaryPR from "./Course-Sections/Hungary-PR";

const HungaryDetails = ({ checkMatchCourses }) => {
  useEffect(() => {
          ...
          <div className="course-details-content">
            ...
            {checkMatchCourses &&
              checkMatchCourses.courseOverview.map((data, index) => (
                <HungaryOverview {...data} key={index} checkMatchCourses={data} />
              ))}
            ...
            >
              {checkMatchCourses &&
                checkMatchCourses.courseContent.map((data, index) => (
                  <HungaryContent {...data} key={index} checkMatchCourses={data} />
                ))}
            </div>
