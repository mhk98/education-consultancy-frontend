...
const DenmarkOverview = ({ checkMatchCourses }) => {
      ...
      >
        <div className="rbt-course-feature-inner has-show-more-inner-content">
          ...
          <div className="section-title">
            <h4 className="rbt-title-style-3">🇩🇰 Study in Denmark – A Guide for Bangladeshi Students
            </h4>
          </div>
          <p>Denmark is renowned for its high-quality education system, innovative teaching methods, and a strong emphasis on sustainability and social welfare. The country offers a wide range of English-taught programs at both undergraduate and postgraduate levels, making it an attractive destination for international students, including those from Bangladesh.</p>
...
export default DenmarkOverview;
