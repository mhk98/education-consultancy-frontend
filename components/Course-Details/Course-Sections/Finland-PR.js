  ...
  return (
    <>
      ...
      <div>
        ...
        <ul>
          <li>After completing your studies, you can apply for a residence permit to search for employment or start a business.</li>
          <li>The permit is valid for up to 12 months.</li>
          <li>During this period, you can work in any job without a separate work permit.</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul>
          <li>After four years of continuous legal residence in Finland, you may be eligible to apply for permanent residency.</li>
          <li>You must demonstrate stable income, good conduct, and proficiency in the Finnish language.</li>
        </ul>
      </div>
    </>
  );
