...
const FinlandOverview = ({ checkMatchCourses }) => {
      ...
      >
        <div className="rbt-course-feature-inner has-show-more-inner-content">
          ...
          <div className="section-title">
            <h4 className="rbt-title-style-3">🇫🇮 Study in Finland – A Guide for Bangladeshi Students
            </h4>
          </div>
          <p>Finland is renowned for its high-quality education system, innovative research, and a strong emphasis on sustainability and social welfare.
...
export default FinlandOverview;
