...
// export default FinlandRequirements;
      ...
      <div className="col-lg-12">
        ...
        <div>
          ...
          <ul>
            ...
            <li><span className="fw-bold">Language Proficiency:</span> IELTS score of 6.0 or higher, with no section below 5.5.</li>
        ...
        <div>
          ...
          <ul>
            ...
            <li><span className="fw-bold">Language Proficiency:</span> IELTS score of 6.5 or higher, with no section below 5.5.</li>
