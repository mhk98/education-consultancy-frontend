  ...
  return (
    <>
      <div className="col-lg-12">
        <div className="d-flex align-items-center gap-3">
          <h5>
            <IoMdCheckbox color="green" size={24} />
          </h5>
          <h5 className="">Admission Requirements for Bangladeshi Students</h5>
        </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              <span className="fw-bold">Language Proficiency:</span> IELTS score of 6.0–6.5 or equivalent.
            </li>
            <li>
              <span className="fw-bold">Additional Requirements:</span> Some programs may require specific subject prerequisites or entrance exams. (manchester.mofa.gov.bd)
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              <span className="fw-bold">Language Proficiency:</span> IELTS score of 6.5–7.0 or equivalent.
            </li>
            <li>
        ...
        <p>
          <span className="fw-bold">Note:</span> Requirements may vary by institution and program. It's essential to check specific university guidelines.
        </p>
      </div>
    </>
  );
