  ...
  return (
    <>
      ...
      <div>
        ...
        <ul>
          <li>After four years of continuous legal residence in Sweden, you may be eligible to apply for permanent residency.</li>
          <li>You must demonstrate stable income, good conduct, and proficiency in the Swedish language.</li>
        </ul>
      </div>
    </>
  );
