    ...
    <>
      ...
      <div>
        ...
        <ul>
          ...
          <li>The permit is valid for up to 6 months.</li>
          <li>During this period, you can work in any job without a work permit.</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul>
          <li>After four years of continuous legal residence in Denmark, you may be eligible to apply for permanent residency.</li>
          <li>You must demonstrate stable income, good conduct, and proficiency in the Danish language.</li>
        </ul>
      </div>
    </>
  );
