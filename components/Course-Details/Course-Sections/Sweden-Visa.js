...
// const SwedenVisa = ({ checkMatchCourses }) => {
//   return (
//     <>
  ...
  return (
    <>
      <div className="col-lg-12">
        ...
        <p><span className="fw-bold">Visa Type:</span> Residence Permit for Studies</p>

        <div>
          <h6 className="fw-bold">Application Steps:</h6>
          <ul>
            <li><span className="fw-bold">Obtain Admission:</span> Secure an acceptance letter from a recognized Swedish university.</li>
            ...
            <li><span className="fw-bold">Submit Application:</span> Apply online through the Swedish Migration Agency's website.</li>
            <li><span className="fw-bold">Schedule Biometrics Appointment:</span> After submitting the application, schedule an appointment at the Swedish Visa Application Centre in Dhaka to provide biometric data (fingerprints and photograph).</li>
        ...
        <div>
          ...
          <ul>
            ...
            <li>Valid passport (valid for at least three months after your departure from Sweden).</li>
            <li>Recent passport-sized photograph.</li>
            <li>Letter of acceptance from a Swedish university.</li>
            <li>Proof of sufficient financial means (bank statements, scholarship letters).</li>
            <li>Health insurance coverage.</li>
            <li>Proof of tuition fee payment.</li>
            <li>Application fee receipt (approximately 1,500 SEK).</li>
          </ul>
        </div>
        ...
        <div>
          <h6 className="fw-bold">Embassy and Resources:</h6>
          <ul>
            <li><span className="fw-bold">Embassy of Sweden in Dhaka:</span> <a className="text-primary" href="https://www.swedenabroad.se/en/embassies/bangladesh-dhaka/">Visit Website</a></li>
            <li><span className="fw-bold">Student Visa Document Checklist:</span> <a className="text-primary" href="https://www.migrationsverket.se/English/Private-individuals/Studying-in-Sweden.html">Download Checklist</a></li>
          </ul>
        </div>
      </div>
    </>
