...
// export default MalaysiaRequirements;
    ...
    <>
      <div className="col-lg-12">
        ...
        <div>
          <h6 className="fw-bold">Undergraduate Programs:</h6>
          <ul>
            <li><span className="fw-bold">Academic Qualifications:</span> Higher Secondary Certificate (HSC) or equivalent with strong academic performance.</li>
            <li><span className="fw-bold">Language Proficiency:</span> IELTS score of 5.0–6.0 or equivalent, depending on the program.</li>
            <li><span className="fw-bold">Additional Requirements:</span> Specific subject prerequisites may apply for certain programs.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li><span className="fw-bold">Language Proficiency:</span> IELTS score of 6.0–6.5 or equivalent, depending on the program.</li>
