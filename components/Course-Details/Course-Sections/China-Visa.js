...
// const ChinaVisa = ({ checkMatchCourses }) => {
//   return (
//     <>
  ...
  return (
    <>
      <div className="col-lg-12">
        ...
        <p>
          <span className="fw-bold">Visa Type:</span> Student Visa (X1 for long-term study over 180 days; X2 for short-term study up to 180 days)
        </p>

        <div>
          <h6 className="fw-bold">Application Steps:</h6>
          <ul>
            <li><span className="fw-bold">Obtain Admission:</span> Secure an acceptance letter from a recognized Chinese university.</li>
            <li><span className="fw-bold">Prepare Documents:</span> Gather necessary documents, including the JW201 or JW202 form issued by the university.</li>
            <li><span className="fw-bold">Submit Application:</span> Apply at the Chinese Embassy or Consulate in Bangladesh.</li>
        ...
        <div>
          ...
          <ul>
            ...
            <li>Admission letter from the Chinese university</li>
            <li>JW201 or JW202 form</li>
            <li>Physical examination record</li>
            <li>Proof of financial means (bank statements, scholarship letters)</li>
          </ul>
        </div>
        ...
        <div>
          <h6 className="fw-bold">Embassy and Resources:</h6>
          <ul>
            <li><span className="fw-bold">Embassy of China in Bangladesh:</span> <a className="text-primary" href="https://bd.china-embassy.gov.cn/eng/">Visit Website</a></li>
            <li><span className="fw-bold">Student Visa Information:</span> <a className="text-primary" href="https://www.visaforchina.cn/">Visa Application Guidelines</a></li>
          </ul>
        </div>
      </div>
    </>
