...
// export default BelgiumRequirements;
    ...
    <>
      <div className="col-lg-12">
        ...
        <div>
          <h6 className="fw-bold">Undergraduate Programs:</h6>
          <ul>
            <li><span className="fw-bold">Academic Qualifications:</span> Higher Secondary Certificate (HSC) with a strong academic record.</li>
            <li><span className="fw-bold">Language Proficiency:</span> IELTS score of 6.0 or higher for English-taught programs; proficiency in French or Dutch for programs taught in those languages.</li>
            <li><span className="fw-bold">Additional Requirements:</span> Some programs may require specific subject prerequisites or entrance examinations.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li><span className="fw-bold">Language Proficiency:</span> IELTS score of 6.5 or higher for English-taught programs; proficiency in French or Dutch for programs taught in those languages.</li>
